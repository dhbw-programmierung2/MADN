...
/**
 * Diese Klasse repr�sentiert den Game Launcher.
...
public class Game_Launcher extends JFrame implements ActionListener {
	...
	private JRadioButton lblSpieler1 = new JRadioButton("Spieler1");
	private JRadioButton lblSpieler2 = new JRadioButton("Spieler2");
	private JRadioButton lblSpieler3 = new JRadioButton("Spieler3");
	private JRadioButton lblSpieler4 = new JRadioButton("Spieler4");
	private JRadioButton lblSpieler5 = new JRadioButton("Spieler5");
	private JRadioButton lblSpieler6 = new JRadioButton("Spieler6");
...
//	private JButton btConfirmColour = new JButton("Farbe best�tigen");
	...
	//	btConfirmColour.setBounds(550, 150, 150, 20);
		...
		/*
		 * Hinzuf�gen der Buttons und Lables in den Container
		 */
		cp.add(lblWelcome);
	...
	//	cp.add(btConfirmColour);
		 ...
		 * Gr��e in Pixeln des Fensters festlegen
		 */
